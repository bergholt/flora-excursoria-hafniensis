...
to **Salomon Thomas Nicolai Drejer, *Flora Excursoria Hafniensis*, Kjøbenhavn 1838**, with a Prolog interface to an interactive archive of it.
...
| `data/index.csv` | The same 903 rows as CSV. Generated by `build.pl`; not tracked here. |
...
MIT for the code — `flora.pl`, `build.pl`, `tests.pl`, `Makefile`.
